...
| Data Cache Connection Plugin                                                                                      | `dataCache`               | Any database                    | Caches results locally from SQL queries matching the regular expression specified in the  `dataCacheTriggerCondition` configuration parameter.                                                                                                                                                                                                                                                                                                                                                                         | None                                                                                                                                                                                                          |
